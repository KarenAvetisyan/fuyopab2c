        ...
        if (form) {
            ...
            async function formSubmit(e, form) {
                ...
                if (error != 0) {
                    ...
                    form.submit(); 
                    form.querySelector('._form-success').classList.add('show');
                    setTimeout(() => {
                        form.querySelector('._form-success').classList.remove('show');
                    }, 4000)
                    form.querySelector('._form-success__close').addEventListener('click', () => {
                        form.querySelector('._form-success').classList.remove('show');
                    })
                    form.reset();
                }
